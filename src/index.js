...
ReactDOM.render(
  <Provider store={store}>
    <Router>
      <Routes>
        <Route path="/" element={<ProfileForm />} />
        <Route path="/profile" element={<ProfileForm />} /> {/* Add explicit profile route */}
        <Route path="/education" element={<EducationForm />} />
        <Route path="/skills" element={<SkillsForm />} />
        <Route path="/projects" element={<ProjectsForm />} />
        <Route path="/social" element={<SocialMediaForm />} /> {/* Changed to match navigation */}
        <Route path="/socialMedia" element={<SocialMediaForm />} /> {/* Keep both for compatibility */}
        <Route path="/finalResume" element={<FinalResume />} />
      </Routes> 
    </Router>
  </Provider>,
